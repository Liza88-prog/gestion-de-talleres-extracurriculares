...
<head>
    ...
    <title>Registro - Sistema Talleres</title>
        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <form class="mt-8 space-y-6" method="POST" action="/register">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label for="role" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Tipo de usuario</label>
